An example with the __Draw Polyline Button__ component.
- If the __*min number of vertex positions*__ are not provided, the default will be 2.
...
import DrawPolylineButton from './DrawPolylineButton';
